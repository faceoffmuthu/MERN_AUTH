...
import { lock_icon, logo, mail_icon } from '../assets/images'
...
const Resetpassword = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400 font-outfit'>
...
{/* enter email id */}
    ...
    {!isEmailSent && 
       <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <button className='w-full py-2.5 rounded-full mt-3 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white font-medium cursor-pointer'>Send OTP</button>        
       </form>
}
       {/* Otp input form */}
      ...
      {isOtpSubmitted && isEmailSent && 
       <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
        ...
        <button className='w-full py-2.5 rounded-full mt-3 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white font-medium cursor-pointer'>Submit</button>        
       </form>
      }
    </div>
  )
